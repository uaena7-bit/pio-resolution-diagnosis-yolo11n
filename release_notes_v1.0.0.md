...
- notes for strict global-first diagnostic AP;
- traceability logs for the YOLOv8n timing recheck and the YOLO11n 30-repeat locked-weight deployment benchmark.

No changes were made to the leakage-controlled PIO split, leakage-audit pass/fail results, primary PIO dataset partition, or original PIO image data. The original PIO and VisDrone2019-DET images are not redistributed. Users should obtain the raw datasets from their original dataset sources.
